...
# don't delete .pot, .po and .gmo with make clean
...
function(configure_gettext)
    ...
    foreach(lang IN LISTS GETTEXT_LANGUAGES)
        ...
        # .po ---{msgfmt}---> .gmo
        if(NOT EXISTS "${GETTEXT_GMOFILE_DESTINATION}/${lang}/${GETTEXT_DOMAIN}.gmo")
            message(STATUS "Creating initial .gmo file for ${lang}")
            execute_process(
