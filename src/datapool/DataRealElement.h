...
#if !defined(__DP_DATA_REAL_ELEMENT__)
#define __DP_DATA_REAL_ELEMENT__

#include "datapool/DataElement.h"

class DataValue;

/** Das DataRealElement enthält einen Wert des Typs double inklusive der
 ...
 */
class DataRealElement : public DataElement
{
...
protected:
   ...
   */
  DataRealElement( const DataRealElement &ref );
   ...
   */
  DataRealElement& operator=(const DataRealElement &ref);
