...
If the dashboard doesn't trigger the login automatically, there's a button on the site to do it manually.

*** OAuth in DB-dashboard

If you set the Workbook to use OAuth, you will also need to set up the dashboard accordingly.
The dashboard needs a public client and you will need to give it the different endpoints manually:
