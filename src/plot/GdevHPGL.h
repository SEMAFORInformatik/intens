...
#define GDEVHPGL_H
/** GdevHPGL.
    Die Klasse GdevHPGL sorgt für die Ausgabe von Grafikelementen
    auf einen Stream (iostream) in HPGL-Format
*/
#include <sstream>
#include <string>
...
public:
  ...
  /** Der Konstruktor hat die folgenden Parameter:
      ...
      @param fontnames Font-Bezeichner
  */
  GdevHPGL( std::ostream &ostr, const std::string& title
