...
#if !defined(__DP_DATA_ALTER_GET_ELEMENT__)
#define __DP_DATA_ALTER_GET_ELEMENT__
...
/** Mit einem DataAlterGetElement-Objekt wird genau ein DataElement-Objekt im
    Datenbaum gesucht.
    @author Copyright (C) 2015  SEMAFOR Informatik & Energie AG, Basel, Switzerland
 */
class DataAlterGetElement : public DataAlterFunctor
{
/*=============================================================================*/
...
public:
  /** Konstruktor
      \todo Die Beschreibung der Funktion DataAlterGetElement fehlt
   */
  DataAlterGetElement();
...
public:
  ...
  /** Die Funktion liefert den Pointer auf das gesuchte DataElement. Wenn das Objekt
      nicht vorhanden ist, wird ein Null-Pointer geliefert.
      @return Pointer auf ein DataElement-Objekt
   */
  const DataElement *getElement() const;

  /** Die Funktion liefert den Pointer auf das DataItem-Objekt des gesuchten Elements.
