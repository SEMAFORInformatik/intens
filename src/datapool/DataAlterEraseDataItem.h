...
#if !defined(__DP_DATA_ALTER_ERASE_DATAITEM__)
#define __DP_DATA_ALTER_ERASE_DATAITEM__

#include "datapool/DataAlterFunctor.h"

/** Mit einem DataAlterEraseDataItem-Objekt wird genau ein DataItem ungültig.
    Alle angehängten DataElemente werden gelöscht.
 */
class DataAlterEraseDataItem : public DataAlterFunctor
{
/*=============================================================================*/
...
public:
  /** Konstruktor
      \todo Die Beschreibung der Funktion DataAlterEraseDataItem fehlt
   */
  DataAlterEraseDataItem( bool incl_itemattr=false );

  /** Destruktor
      \todo Die Beschreibung der Funktion ~DataAlterEraseDataItem fehlt
   */
  virtual ~DataAlterEraseDataItem();
