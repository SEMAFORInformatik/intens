...
commandline option \texttt{--}unitManager.

As mentioned, the Unit Manager handles the automatic scaling of values
...
as labels.
%
To do so, provide one of two values to the commandline option unitManager:
\begin{itemize}
...
If you prefer to see a combobox for all (known) units, use the commandline
option \newline
