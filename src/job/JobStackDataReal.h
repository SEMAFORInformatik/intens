...
#if !defined(JOB_STACK_DATA_REAL_INCLUDED_H)
#define JOB_STACK_DATA_REAL_INCLUDED_H

#include "job/JobStackData.h"

class JobStackDataReal : public JobStackData
{
/*=============================================================================*/
/* Constructor / Destructor                                                    */
/*=============================================================================*/
public:
  JobStackDataReal( double value )
    : JobStackData( true )
    , m_value( value ){
  }
  virtual ~JobStackDataReal(){}
...
public:
  ...
  */
  DataDictionary::DataType getDataType() { return DataDictionary::type_Real; }

  /** Diese Funktion erstellt eine Kopie des Objekts.
      @return Pointer auf neues Objekt.
  */
  virtual JobStackDataReal *clone();
