...
There is an additional argument you can pass called --oauthAccessTokenUrl containing a list of the requested scopes from
your OAuth provider.
If the option is not set, it will request the default list of scopes "openid profile roles".
