...
\index{MATRIX@\MATRIX!datapool attributes}
...
\index{MATRIX@\MATRIX!datapool item option}
...
\DATAPOOL
  ...
  \INTEGER \{\EDITABLE\}
    data\_item\_identifier \{\COLOR = red\_green\_blue\_color\};
