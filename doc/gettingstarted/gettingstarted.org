...
- Install the required python packages:
  ...
  usually named as ~pyproject.toml~. The following packages are required:
#+begin_example
Jinja2
lxml
Mako
...
#+begin_example
(training) ~/intens-training $ uv add Jinja2 lxml Mako PypInstaller python-dateutil requests
#+end_example
