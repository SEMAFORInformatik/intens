...
\index{FUNC@\FUNC!folder tab option}
\index{PIXMAP@\PIXMAP!folder tab option}
\index{HIDDEN@\HIDDEN!folder tab option}
\begin{tabularx}{\textwidth}{l|X}
...
\HIDDEN                  & folder button is not created when string or int evaluates to \TRUE{}
                           (string: not empty(``''), ``0'' or ``false'' (case insensitive),
                            int: not 0). \newline
