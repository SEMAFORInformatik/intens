...
\begin{tabularx}{\textwidth}{l|X}
  ...
  \hline
\verb+string+   & With a \BUTTON: \newline
                  show this string on the \BUTTON{} instead of its \LABEL. \newline
                  Combine this with \PIXMAP{} to show a \PIXMAP{} and a string on a \BUTTON. \newline
                  Examples: \newline
                  \verb+open { _("Open") }+ \newline
                  \verb+open { PIXMAP="open", _("Open") }+ \newline
                  \verb+open { PIXMAP="open", LABEL(open) }+
                  \\
...
\index{ACCORDION@\ACCORDION!fieldgroup option}
\index{OPEN@\OPEN!fieldgroup option (\ACCORDION)}
\index{PIXMAP@\PIXMAP!fieldgroup option (\ACCORDION)}
\index{PIXMAP\_OPEN@\PIXMAPOPEN!fieldgroup option (\ACCORDION)}
\index{PIXMAP\_CLOSE@\PIXMAPCLOSE!fieldgroup option (\ACCORDION)}
\index{FUNC@\FUNC!fieldgroup option}
\index{OVERLAY@\OVERLAY!fieldgroup option}
\begin{tabularx}{\textwidth}{l|X}
option              & description \\
\hline
...
\ACCORDION          & displays the \FIELDGROUP{} with a header and a body. \newline
                      It has a toggle button, that expands or collapses the body.
                      The button label uses the title of the \FIELDGROUP{}. \\
...
\PIXMAPOPEN{}       & sets the individual image for an expanded \FIELDGROUP{}. \\
\PIXMAPCLOSE{}      & sets the individual image for a collapsed \FIELDGROUP{}. \\
\FUNC               & Identifier of previously defined function, which will be executed by selecting the \FIELDGROUP. \\
\OVERLAY            & allows placing a \FIELDGROUP{} anywhere over its parent \FIELDGROUP{}, similar to CSS \verb|position: absolute|. The element does not occupy layout space. \newline
