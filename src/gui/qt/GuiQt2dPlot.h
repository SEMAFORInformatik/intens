...
#ifndef GUI_QT_2D_PLOT_H
#define GUI_QT_2D_PLOT_H
#if HAVE_QCHARTS
...
class GuiQt2dPlot : public GuiQtElement, public Gui2dPlot {
    Q_OBJECT
public:
  ...
  // public:
  //   MyQwtPlot(QWidget *parent, GuiQt2dPlot *plot);
  //   virtual ~MyQwtPlot() {}
  ...
  //------------------------------------
  GuiQt2dPlot( const std::string &name );
  virtual ~GuiQt2dPlot();
 private:
  GuiQt2dPlot( const GuiQt2dPlot &plot);
...
//   {
//   public:
//     ZoomListener( GuiQt2dPlot *plot ): m_plot( plot ) {}
...
//   {
//   public:
//     OpenConfigListener( GuiQt2dPlot *plot ): m_plot( plot ) {}
//     virtual void ButtonPressed();
//     virtual JobAction *getAction(){ return 0; }
//   private:
//     GuiQt2dPlot  *m_plot;
...
//   {
//   public:
//     AnnotationListener( GuiQt2dPlot *plot ): m_plot( plot ) {}
//     virtual void ToggleStatusChanged( bool state );
//   private:
//     GuiQt2dPlot  *m_plot;
//   };
...
//   {
//   public:
//     PropertyListener( GuiQt2dPlot *plot ): m_plot( plot ), m_propDlg(0) {}
//     virtual void ButtonPressed();
//     virtual JobAction *getAction(){ return 0; }
...
//   public:
//     UserInteractionModeMenu( GuiQt2dPlot *plot )
//       : m_plot( plot )
//       , m_zoomButton( 0 )
...
//  public:
//  Trigger( JobFunction *f, GuiQt2dPlot *plot )
...
private:
  ...
  QImage roundrect(qreal imageSize, const QColor &color);
  QRectF getBoundingBox(QXYSeries *series);
  void clearBoundingBox();
  void setBoundingBox(eAxisType axis, double min, double max);
  bool getBoundingBox(eAxisType axis, double&min, double& max);
  QAbstractAxis* createAxis(GuiPlotDataItem* plotDataItem, PlotAxis& plotAxis);
...
//   friend class GuiQwtPlotLayout;
  ...
  QAbstractAxis* m_y1axis;
  QAbstractAxis* m_y2axis;
  double         m_ranges[4][2];
};
#endif
#endif
