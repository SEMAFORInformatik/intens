...
protected:
   ...
   */
  DataComplexElement( const DataComplexElement &ref );
   ...
   */
  DataComplexElement& operator=( const DataComplexElement &ref );
...
public:
  ...
  inline virtual DataDictionary::DataType getElementType() const{
    return DataDictionary::type_Complex;
  }
  ...
  */
  ...
  /** Die Funktion erstellt eine exakte Kopie des Containers und liefert den
      ...
      @return Pointer auf den neuen Container
  */
