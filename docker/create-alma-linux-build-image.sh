#!/bin/bash
# script to create docker image semafor/intens/almalinux-build
#
...
IMG_NAME=ghcr.io/semaforinformatik/intens/almalinux-build
docker build \
       ...
       -t ${IMG_NAME}:latest -f $path/Dockerfile-alma-linux-build $parent
