...
public:
  /** Konstruktor
      \param int oldnum
      \param int newnum
      \todo Die Beschreibung der Funktion DataTTrailCycleNew fehlt
   */
  DataTTrailCycleNew( int oldnum, int newnum );

  /** Destruktor
   */
  virtual ~DataTTrailCycleNew() {}

/*=============================================================================*/
/* public member functions                                                     */
/*=============================================================================*/
public:
  BUG_DECL_SHOW_COUNT("DataTTrailCycleNew");
